getgenv().SilentAimbotKey = 'c'; getgenv().AimlockKey = 'q';  _G.WEBHOOK_URL = 'https://discord.com/api/webhooks/934534681544761495/xFqUZsE_Qhz_-2szp3tvTn20fZkt_Fb8WSKmN04q7dpCDhu_4swtsN8IijjkIypXncHv';
...
--// variables etc
    ...
    local LoaderTitle = "hoodsense.cc"
    ...
    AcceptButton.MouseButton1Click:Connect(
        function()
            ...
            Loader:Destroy()
            wait(2)
            if isfile("hoodsense.cc") then
                if readfile("hoodsense.cc") ~= "_disabled" then
                    local StarterGui = game:GetService("StarterGui") -- not sure why you used CoreGui
                    local bindable = Instance.new("BindableFunction")

                    function bindable.OnInvoke(response)
                        if response == "Yes" then
                            writefile("hoodsense.cc", "_disabled")
                            StarterGui:SetCore(
                                "SendNotification",
                                {
                                    Title = "hoodsense.cc",
                    ...
                    StarterGui:SetCore(
                        ...
                        {
                            Title = "hoodsense.cc",
                            Text = "Would you like to disable the join discord GUI?",
                            Duration = 5,
                            Callback = bindable,
                            Button1 = "Yes",
                            Button2 = "No"
        ...
        function()
            ...
            if isfile("hoodsense.cc") then
                if readfile("hoodsense.cc") ~= "_disabled" then
                    ...
                    GameInfo.Text = "Would you like to join the script server?"
...
do
    ...
    --// HOODSENSE.CC UI
	local IMGUIWindow = library:AddWindow("hoodsense.cc", {
	...
	local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/Riheusz/hoodsense.ccESP/main/ESP.lua"))() --// ESP Library
	...
	do
		...
		anotherTab:AddLabel("EKSO FOR FIX")
		anotherTab:AddLabel("EKSO'S GF<3")
		anotherTab:AddLabel("KITTENASSIST OWNER")
		anotherTab:AddLabel("RIGHTSHIFT TO CLOSE GUI")
		...
		miscTab:AddTextBox("Speed (use -0.10 to -0.60)", function(a)
		...
		miscTab:AddButton("Auto Clicker (B)", function()
			local Player = game:GetService("Players").LocalPlayer
			local Mouse = Player:GetMouse()
...
print("[hoodsense.cc] SPEED GLITCH MUST BE ENABLED!")
