...
local objects = {}
local themes = {
	Background = Color3.fromRGB(12, 21, 57)
	Glow = Color3.fromRGB(0, 63, 255),
	Accent = Color3.fromRGB(0, 63, 255),
	LightContrast = Color3.fromRGB(36, 48, 129),
	DarkContrast = Color3.fromRGB(11, 11, 90), 
...
print("[hoodsense.cc] Venyx ui library loaded!")
return library
