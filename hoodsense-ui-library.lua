...
local themes = {
	...
	Glow = Color3.fromRGB(46, 46, 255),
	Accent = Color3.fromRGB(0, 3, 44),
	LightContrast = Color3.fromRGB(0, 3, 44),
	DarkContrast = Color3.fromRGB(0, 0, 30),  
...
print("[hoodsense.cc] Ui library loaded!")
return library
